...
class _$ResultStateTearOff {
  ...
  Error<T> error<T>(DioExceptions error) {
    return Error<T>(
      error,
    );
  }
...
mixin _$ResultState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(DioExceptions error) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(DioExceptions error)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class Error<T> implements ResultState<T> {
  const factory Error(DioExceptions error) = _$Error<T>;
