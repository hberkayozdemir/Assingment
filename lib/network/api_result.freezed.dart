...
class _$ApiResultTearOff {
  ...
  Failure<T> failure<T>(DioExceptions error) {
    return Failure<T>(
      error,
    );
  }
...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(DioExceptions error) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(T data)? success,
    TResult Function(DioExceptions error)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class $FailureCopyWith<T, $Res> {
  ...
  $Res call({DioExceptions error});

  $DioExceptionsCopyWith<$Res> get error;
}
...
class _$FailureCopyWithImpl<T, $Res> extends _$ApiResultCopyWithImpl<T, $Res>
  ...
  @override
  $DioExceptionsCopyWith<$Res> get error {
    return $DioExceptionsCopyWith<$Res>(_value.error, (value) {
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(DioExceptions error) = _$Failure<T>;

  DioExceptions get error;
  @JsonKey(ignore: true)
  $FailureCopyWith<T, Failure<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
